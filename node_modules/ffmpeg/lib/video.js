...
module.exports = function (filePath, settings, infoConfiguration, infoFile) {
	...
	/**
	 * Splitting audio at splitStart until splitEnd
	 */
	this.fnSplitSoundToMP3 = function (destionationFileName, splitStart, splitEnd, callback) {
		...
		this.addCommand('-ss', splitStart);
		if (splitEnd != undefined) {
			this.addCommand('-t', splitEnd);
		}
